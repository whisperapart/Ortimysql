...
# PRD
class JDConfig:
    kafka_bootstrap_server = '10.0.0.179:9092'
    kafka_topic_user_info = 'togg'
    kafka_topic_company_info = 'company_info'
    # kafka_group_id = 'group_id'
    kafka_group_id_info = 'group_id_info'
    mysql_server = '10.0.0.124'
    mysql_user = 'wuxihuishan_policy_match'
    mysql_psw = '123456'
    mysql_db = 'wuxihuishan_policy_match'
    mysql_table = {}
    ...
    oracle_server = '10.0.0.12:/orcl'
    oracle_user = 'wuxihuishan'
    oracle_psw = 'JSCYnjcy2018oracle'
    oracle_db = 'WUXIHUISHAN'
    oracle_table = {}
